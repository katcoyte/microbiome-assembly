...
repeats = 150;
plotOn =0; % plot assembly landscape, yes or no
sigma_vec = [0.025, 0.05, 0.075, 0.1, 0.125]; % range of interaction strengths

invasion_level = 0.1; % abundance at which new species introduced
cut_off_level = 0.01; % abundance at which 
    ...
    for pm_index = 1:length(PmSpace)
        ...
        for rep = 1:repeats
            ...
            [cap_reachable,...
                ...
                cap_all_communities,...
                cap_all_permanences,...
                cap_all_steady_states] = single_assembly_run(M,...
                mu,...
                S,...
                C,...
                Pm,...
           ...
           % Run with feeding
                    [cap_reachable_fed,...
                        ...
                        cap_all_steady_states_fed] = single_assembly_run(M,...
                        mu+0.1*ones(S,1),...
                        S,...
                        C,...
                        Pm,...
...
%            Run with two species arriving together
                    ...
                    [cap_reachable_ma1,...
                        ...
                        cap_all_steady_states_ma1] = single_assembly_run(M,...
                        mu,...
                        S,...
                        C,...
                        Pm,...
...
%            Run with three species arriving together
                    ...
                    [cap_reachable_ma2,...
                        ...
                        cap_all_steady_states_ma2] = single_assembly_run(M,...
                        mu,...
                        S,...
                        C,...
                        Pm,...
